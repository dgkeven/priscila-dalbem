  ...
  return (
    <div className="p-4 lg:p-6 bg-gray-50 min-h-screen">
      ...
      <div className="mb-6 flex flex-wrap gap-2 lg:gap-2">
        {(["all", "scheduled", "completed", "cancelled"] as FilterStatus[]).map(
          (status) => (
            <button
              key={status}
      ...
      <div className="grid gap-4">
        {filteredAppointments.map((appointment) => (
          <div
            key={appointment.id}
            className="bg-white rounded-lg lg:rounded-xl shadow-lg p-4 lg:p-6 hover:shadow-xl transition-all duration-300"
          >
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex flex-col lg:flex-row lg:items-center space-y-2 lg:space-y-0 lg:space-x-4 mb-4">
                  ...
                  <span
                    className={`px-2 lg:px-3 py-1 text-xs lg:text-sm rounded-full font-medium ${getStatusColor(
                      appointment.status
                    )}`}
                  >
      ...
      {filteredAppointments.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg lg:text-xl font-medium text-gray-600 mb-2">
